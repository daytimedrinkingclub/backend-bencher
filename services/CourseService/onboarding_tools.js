module.exports = [
  {
    ...
    "input_schema": {
      ...
      "properties": {
        "question_format": {
          "type": "string",
          "description": "The format of the question, and expected answer format, from only these options: subjective, radio, checkbox, scale, datepicker"
        },
        "question_text": {
          "type": "string",
      ...
      "required": ["question_format", "question_text", "answer_type", "answer_values"]
    }
  },
  {
