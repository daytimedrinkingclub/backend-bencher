...
const { createCheckpointItem } = require("./utils");
...
class OnboardingService {
  ...
  async askOnboardingQuestion() {
    ...
    this.query = this.course.dataValues.input_query;
    ...
    if (response.stop_reason === "tool_use") {
      ...
      if (toolName === "get_user_data") {
        const { question_format: questionType, question_text: question, question_meta: meta } = toolInput;
